    ...
    <div className="form-box">
      <form className="Movie-Forum" onSubmit={handleSubmitForm}>
        ...
        <select id="title" name="title" required>
          ...
          <option value="Harry Potter and the Chamber of Secrets">
            Harry Potter and the Chamber of Secrets
          </option>
          <option value="Harry Potter and the Prisoner of Azkaban">
            Harry Potter and the Prisoner of Azkaban
          </option>
          <option value="Harry Potter and the Goblet of Fire">
          ...
          <option value="Harry Potter and the Deathly Hallows Part 1">
            Harry Potter and the Deathly Hallows Part 1
          </option>
          <option value="Harry Potter and the Deathly Hallows Part 2">
